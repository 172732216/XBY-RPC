package com.xby.rpc.constant;

public class RpcConstant {
    public static final  int SERVER_PORT=8888;
    public static final  String ZK_IP="127.0.0.1";
    public static final  int ZK_PORT=2181;
    public  static final String ZK_RPC_ROOT_PATH="/xby-rpc";

    public static final String NETTY_RPC_KEY="RpcResp";
    public static final byte[] RPC_MAGIC_CODE=new byte[]{(byte)'p',(byte)'r',(byte)'p',(byte)'c'};
